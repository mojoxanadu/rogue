#!/usr/bin/env python3
"""
Embed referenced images as data URLs into HTML (for v5).
"""
import re
import base64
import mimetypes
...
def main():
    html_file = Path('asset_selector_v5.html')
    ...
    out_file = Path('asset_selector_v5_embedded.html')
    ...
    embedded_count = embedded.count('data:image')
